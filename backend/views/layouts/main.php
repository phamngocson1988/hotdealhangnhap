        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title"><i class="fa fa-paw"></i> <span>Hotdeal Admin!</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-users"></i> Users <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= Url::to(['customer/index']) ?>">Customers</a></li>
                      <li><a href="<?= Url::to(['customer/create']) ?>">Create Customer</a></li>
                  ...
                  <?php if (Yii::$app->user->can('sale')) : ?>
                  <li><a><i class="fa fa-shopping-cart"></i> Orders <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= Url::to(['order/index']) ?>">Orders</a></li>
                      <li><a href="<?= Url::to(['order/create']) ?>">Create</a></li>
                    </ul>
                  </li>
                  <?php endif;?>

                  <?php if (Yii::$app->user->can('us_keeper') || Yii::$app->user->can('vn_keeper')) : ?>
                  <li><a><i class="fa fa-hashtag"></i> Items <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= Url::to(['item/index']) ?>">Items</a></li>
                    </ul>
                  </li>
                  <?php endif;?>
                </ul>
                <?php if (Yii::$app->user->can('sale')) : ?>
                <a href="<?= Url::to(['order/create']) ?>"type="button" class="btn btn-default btn-lg btn-block">Create Order</a>
                <?php endif;?>
              </div>
            </div>
            <!-- /sidebar menu -->
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <!-- <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img global="avatar" src="../../images/avatar.png" alt="Profile Image" /></span>
                        <span>
